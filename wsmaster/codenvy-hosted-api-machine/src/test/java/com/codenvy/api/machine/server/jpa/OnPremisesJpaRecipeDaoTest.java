...
public class OnPremisesJpaRecipeDaoTest {
    ...
    public void setupEntities() throws Exception {
        permissionses = new RecipePermissionsImpl[] {new RecipePermissionsImpl("user1", "recipe1", Arrays.asList("read", "use", "")),
    ...
    @Test
    public void shouldFindRecipeByPermissionsAndTagsAndType() throws Exception {
