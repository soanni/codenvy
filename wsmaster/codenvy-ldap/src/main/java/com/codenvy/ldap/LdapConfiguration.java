...
public class LdapConfiguration {
    ...
    public LdapConfiguration(@NotNull @Named("ldap.url") String ldapUrl,
                             ...
                             @Nullable @Named("ldap.dnformat") String dnFormat,
                             @Nullable @Named("ldap.userpasswordattribute") String userPasswordAttribute,

                             @Named("ldap.usessl") boolean useSsl,
                             @Named("ldap.usestarttls") boolean useStartTls,
                             @Named("ldap.authenticationtype") String type,
                             @Nullable @Named("ldap.provider") String providerClass,
                             ...
                             @Nullable @Named("ldap.ssl.trustcertificates") String trustCertificates,
                             @Nullable @Named("ldap.ssl.keystore.name") String keystore,
                             @Nullable @Named("ldap.ssl.keystore.password") String keystorePassword,
                             @Nullable @Named("ldap.ssl.keystore.type") String keystoreType,


                             @Nullable @Named("ldap.sasl.realm") String saslRealm,
                             @Named("ldap.sasl.mechanism") String saslMechanism,
                             @Nullable @Named("ldap.sasl.authorizationid") String saslAuthorizationId,
