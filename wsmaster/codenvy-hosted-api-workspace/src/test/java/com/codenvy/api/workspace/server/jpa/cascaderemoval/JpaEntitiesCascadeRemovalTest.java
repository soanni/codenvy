...
import static com.codenvy.api.workspace.server.jpa.cascaderemoval.TestObjectsFactory.createFactory;
import static com.codenvy.api.workspace.server.jpa.cascaderemoval.TestObjectsFactory.createPreferences;
import static com.codenvy.api.workspace.server.jpa.cascaderemoval.TestObjectsFactory.createProfile;
import static com.codenvy.api.workspace.server.jpa.cascaderemoval.TestObjectsFactory.createRecipe;
import static com.codenvy.api.workspace.server.jpa.cascaderemoval.TestObjectsFactory.createSnapshot;
import static com.codenvy.api.workspace.server.jpa.cascaderemoval.TestObjectsFactory.createSshPair;
import static com.codenvy.api.workspace.server.jpa.cascaderemoval.TestObjectsFactory.createStack;
import static com.codenvy.api.workspace.server.jpa.cascaderemoval.TestObjectsFactory.createUser;
import static com.codenvy.api.workspace.server.jpa.cascaderemoval.TestObjectsFactory.createWorker;
import static com.codenvy.api.workspace.server.jpa.cascaderemoval.TestObjectsFactory.createWorkspace;
